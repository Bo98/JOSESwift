...
class RSACryptoTestCase: CryptoTestCase {
    ...
    override func setupKeys() {
                ...
                let keyData4096 = Data(base64Encoded: keyDict[privateKey4096Tag] as! String)
        {
            ...
            let keyPairAlice2048 = CryptoTestCase.setupSecKeyPair(type: kSecAttrKeyTypeRSA as String, size: 2048, data: keyDataAlice2048, tag: privateKeyAlice2048Tag)!
            ...
            let keyPairBob2048 = CryptoTestCase.setupSecKeyPair(type: kSecAttrKeyTypeRSA as String, size: 2048, data: keyDataBob2048, tag: privateKeyBob2048Tag)!
            ...
            let keyPair4096 = CryptoTestCase.setupSecKeyPair(type: kSecAttrKeyTypeRSA as String, size: 4096, data: keyData4096, tag: privateKey4096Tag)!
